...
(Jan 2022 – Dec 2023). For each month and each shared column, compares values
and reports any discrepancies.

Why this matters: 24 months were typed by hand from the same PDFs we now extract
